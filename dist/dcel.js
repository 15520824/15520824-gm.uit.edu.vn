...
function DCEL(GeoJSON, lines) {
     ...
     */
    this.faces = [];
    this.binaryTree = new AVLTree((this.GeoJSON.EXTMAX[0] - this.GeoJSON.EXTMIN[0]) / 2);
    var self = this;
    this.check = [];
    this.check[null] = [];
    ...
    this.myTree = new Quadtree({
        x: self.GeoJSON.EXTMIN[0],
        y: self.GeoJSON.EXTMIN[1],
        width: self.GeoJSON.EXTMAX[0] - self.GeoJSON.EXTMIN[0],
        height: self.GeoJSON.EXTMAX[1] - self.GeoJSON.EXTMIN[1]
    }, 10, 4);
