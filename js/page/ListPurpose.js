...
import NewPurpose from '../component/NewPurpose';
...
ListPurpose.prototype.setContainer = function(parent) {
    this.parent = parent;
}

Object.defineProperties(ListPurpose.prototype, Object.getOwnPropertyDescriptors(BaseView.prototype));
ListPurpose.prototype.constructor = ListPurpose;

ListPurpose.prototype.getView = function() {
    ...
    var PurposeModule = moduleDatabase.getModule("purpose");
    PurposeModule.load().then(function(value) {
        var header = [
...
ListPurpose.prototype.getDataParam = function() {
    return this.listParam;
}

ListPurpose.prototype.formatDataRow = function(data) {
    var temp = [];
    var check = [];
    var k = 0;
...
ListPurpose.prototype.getDataRow = function(data) {
    var result = [
        {},
        data.id,
        data.name,
...
ListPurpose.prototype.formatDataList = function(data) {
...
ListPurpose.prototype.searchControlContent = function() {
    var content = _({
        tag: "div"
    })
    var temp = _({
...
ListPurpose.prototype.getDataCurrent = function() {
    return this.getDataChild(this.mTable.data);
}



ListPurpose.prototype.getDataChild = function(arr) {
    var self = this;
    var result = [];
...
ListPurpose.prototype.add = function(parent_id = 0, row) {
    var self = this;
    var mNewPurpose = new NewPurpose(undefined, parent_id);
    mNewPurpose.attach(self.parent);
    var frameview = mNewPurpose.getView(self.getDataParam());
    self.parent.body.addChild(frameview);
    self.parent.body.activeFrame(frameview);
    self.addDB(mNewPurpose, row);
}

ListPurpose.prototype.addDB = function(mNewPurpose, row) {
    var self = this;
    mNewPurpose.promiseAddDB.then(function(value) {
        moduleDatabase.getModule("purpose").add(value).then(function(result) {
            self.addView(result, row);
        })
        mNewPurpose.promiseAddDB = undefined;
        setTimeout(function() {
            if (mNewPurpose.promiseAddDB !== undefined)
                self.addDB(mNewPurpose);
        }, 10);
    })
}

ListPurpose.prototype.addView = function(value, parent) {
...
ListPurpose.prototype.edit = function(data, parent, index) {
    var self = this;
    var mNewPurpose = new NewPurpose(data);
    mNewPurpose.attach(self.parent);
    var frameview = mNewPurpose.getView(self.getDataParam());
    self.parent.body.addChild(frameview);
    self.parent.body.activeFrame(frameview);
    self.editDB(mNewPurpose, data, parent, index);
}

ListPurpose.prototype.editDB = function(mNewPurpose, data, parent, index) {
    var self = this;
    mNewPurpose.promiseEditDB.then(function(value) {
        var loading = new loadingWheel();
        value.id = data.original.id;
        moduleDatabase.getModule("purpose").update(value).then(function(result) {
            self.editView(value, data, parent, index);
            loading.disable();
        })
        mNewPurpose.promiseEditDB = undefined;
        setTimeout(function() {
            if (mNewPurpose.promiseEditDB !== undefined)
                self.editDB(mNewPurpose, data, parent, index);
        }, 10);
    })
}

ListPurpose.prototype.editView = function(value, data, parent, index) {
...
ListPurpose.prototype.delete = function(data, parent, index) {
    var self = this;
...
ListPurpose.prototype.deleteView = function(parent, index) {
    var self = this;
    var bodyTable = parent.bodyTable;
    parent.dropRow(index).then(function() {});
}

ListPurpose.prototype.deleteDB = function(data, parent, index) {
    var self = this;
    var loading = new loadingWheel();
    moduleDatabase.getModule("purpose").delete({ id: data.id }).then(function(value) {
        self.deleteView(parent, index);
        loading.disable();
    })
}

ListPurpose.prototype.refresh = function() {
    var data;
...
ListPurpose.prototype.setData = function(data) {
    this.data = data;
...
ListPurpose.prototype.flushDataToView = function() {
...
ListPurpose.prototype.start = function() {
