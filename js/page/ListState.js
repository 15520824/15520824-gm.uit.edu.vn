...
ListState.prototype.getView = function () {
    ...
    var nationModule = moduleDatabase.getModule("nations");
        stateModule.load().then(function(value){
            ...
            // self.mTable.setUpSwipe(undefined,[{icon:"close",iconStyle:{color:"white"},text:"Test",background:"green",event:function(event){console.log(event)}},{icon:"close",iconStyle:{color:"white"},text:"Test",background:"blue",event:function(event){self.mTable.slip.animateToZeroHidden()}}]);
        });
    });
