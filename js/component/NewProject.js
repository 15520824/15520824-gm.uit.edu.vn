...
function NewProject(header, dataTable) {
    BaseView.call(this);
    Fragment.call(this);
...
NewProject.prototype.setContainer = function (parent) {
    this.parent = parent;
}

Object.defineProperties(NewProject.prototype, Object.getOwnPropertyDescriptors(BaseView.prototype));
NewProject.prototype.constructor = NewProject;

NewProject.prototype.generalData = function () {
...
NewProject.prototype.getView = function () {
    ...
    this.$view.addChild(_({
        ...
        child: [
            // NewProject.prototype.locationView(),
            NewProject.prototype.descView()
        ]
    }));
...
NewProject.prototype.descView = function () {
    var map = NewProject.prototype.mapView();
    var temp = _({
        tag: "div",
        ...
        child: [
            {
                ...
                child: [
                    NewProject.prototype.descViewdetail(map),
                    NewProject.prototype.descViewImageThumnail(),
                    // NewProject.prototype.descViewImagePreview()
                ]
            },
            {
                tag: "div",
                ...
                child: [
                    ...
                    },
                    {
                        ...
                        child: [
                            NewProject.prototype.juridicalView(),
                            NewProject.prototype.historyView()
                        ]
                    }
                ]
            }
...
NewProject.prototype.descViewdetail = function () {
    var temp = _({
        tag: "div",
...
NewProject.prototype.descViewImagePreview = function () {
    var temp = _({
        tag: "ul",
        class: "slides",
        child: [
...
NewProject.prototype.detructView = function () {
    var temp = _({
        tag: "div",
...
NewProject.prototype.utilityView = function () {
    var temp = _({
        tag: "div",
...
NewProject.prototype.convenientView = function () {
    var temp = _({
        tag: "div",
...
NewProject.prototype.juridicalView = function () {
    var temp = _({
        tag: "div",
...
NewProject.prototype.historyView = function () {
    var temp = _({
        tag: "div",
...
NewProject.prototype.locationView = function () {
    var map = NewProject.prototype.mapView();
    var temp = _({
        tag: "div",
        ...
        child: [
            ...
            },
            {
                ...
                child: [
                    NewProject.prototype.detailView(map),
                    map
                ]
            }
        ]
...
NewProject.prototype.detailView = function (map) {
...
activeAutocomplete.prototype.fillInAddress = function (autocomplete, text, map) {
    ...
    NewProject.prototype.getLongLat(text).then(function (result) {
        console.log(map)
...
NewProject.prototype.mapView = mapView;


NewProject.prototype.getLongLat = function (text) {
...
mapView.prototype.transition = function (result) {
    ...
    window.service.nearbySearch({ location: pyrmont, radius: 500, type: ['school'] },callback);
...
NewProject.prototype.refresh = function () {
    var data;
...
NewProject.prototype.setData = function (data) {
    this.data = data;
...
NewProject.prototype.flushDataToView = function () {
...
NewProject.prototype.start = function () {
